...
public class SmsCodeValidationFilter extends OncePerRequestFilter implements InitializingBean {
    private static final String SESSION_KEY = VerificationCodeProcessor.SESSION_KEY_PREFIX + "SMS";
    ...
    public void afterPropertiesSet() throws ServletException {
        ...
        urls.add("/authentication/sms"); //This is mandatory!!
    }
...
//                && StringUtils.equalsIgnoreCase(request.getMethod(), "post")){
    ...
    private void validate(ServletWebRequest request) throws ServletRequestBindingException {
        VerificationCode codeInSession = (VerificationCode) sessionStrategy.getAttribute(request, SESSION_KEY);
